...
*/
#ifndef NETWORKMODEMINTERFACE_P_H
#define NETWORKMODEMINTERFACE_P_H

#include "networkinterface_p.h"
#include "dbus/nm-device-modeminterface.h"


class NMModemNetworkInterfacePrivate : public NMNetworkInterfacePrivate
{
public:
    NMModemNetworkInterfacePrivate(const QString &path, QObject *owner);
