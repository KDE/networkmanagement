...
#ifndef NM09_WIRELESSNETWORKINTERFACE_P_H
#define NM09_WIRELESSNETWORKINTERFACE_P_H
...
public:
    ...
    uint bitRate;
    Solid::Control::WirelessNetworkInterfaceNm09::Capabilities wirelessCapabilities;
};
