...
namespace Control
{
    class BtNetworkInterfaceNm09Private : public ModemNetworkInterfaceNm09Private
    {
    public:
        explicit BtNetworkInterfaceNm09Private(QObject *parent)
            : ModemNetworkInterfaceNm09Private(parent) { }
