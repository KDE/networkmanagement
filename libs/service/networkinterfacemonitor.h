...
/**
 * Monitors network hardware and maintains NetworkInterfaceConnectableProviders for them
 */
...
public:
    NetworkInterfaceMonitor(ConnectionList * connectionList, ConnectableList * connectableList, QObject * parent);
