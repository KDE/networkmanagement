...
int main( int argc, char **argv )
{
  ...
  pH << "#ifndef " << ( !nameSpace.isEmpty() ? QString(nameSpace.toUpper() + '_') : "" )
    << className.toUpper() << "PERSISTENCE_H" << endl;
  pH << "#define " << ( !nameSpace.isEmpty() ? QString(nameSpace.toUpper() + '_') : "" )
  ...
  dH << "#ifndef " << ( !nameSpace.isEmpty() ? QString(nameSpace.toUpper() + '_') : "" )
    << className.toUpper() << "DBUS_H" << endl;
  dH << "#define " << ( !nameSpace.isEmpty() ? QString(nameSpace.toUpper() + '_') : "" )
