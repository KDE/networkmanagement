...
#ifndef KNM_SECURITY8021XSECRETS_H
#define KNM_SECURITY8021XSECRETS_H
...
class KNMINTERNALS_EXPORT Security8021xSecrets : public Secrets
{
  public:
  ...
  protected:
    Security8021xSetting *m_setting;
};
}
