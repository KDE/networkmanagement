...
CdmaSecrets::CdmaSecrets(CdmaSetting * setting) : Secrets(setting), m_setting(setting)
{
}
...
QMap<QString,QString> CdmaSecrets::secretsToMap() const
{
...
void CdmaSecrets::secretsFromMap(QMap<QString,QString> secrets) const
{
    m_setting->setPassword(secrets.value("password"));
}

void CdmaSecrets::secretsToConfig(QMap<QString,QString> secrets, KSharedConfig::Ptr configptr) const
{
...
QMap<QString,QString> CdmaSecrets::secretsFromConfig(KSharedConfig::Ptr configptr)
{
    QMap<QString,QString> map;
    KConfigGroup * config = new KConfigGroup(configptr, Setting::typeAsString(Setting::Cdma));
    if (config->exists()) {
...
QStringList CdmaSecrets::needSecrets()
{
    QStringList list;
