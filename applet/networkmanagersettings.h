...
public:
    ...
    OrgFreedesktopNetworkManagerSettingsConnectionInterface * findConnection(const QString&) const;
Q_SIGNALS:
...
private:
    QHash<QString, OrgFreedesktopNetworkManagerSettingsConnectionInterface*> m_connections;
    QString m_service;
};
